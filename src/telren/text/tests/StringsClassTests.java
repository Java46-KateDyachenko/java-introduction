...
class StringsClassTests {
	...
	assertArrayEquals(expected3,Strings.deepNoRepeatedCompare(str1,str4));
	assertArrayEquals(expected4,Strings.deepNoRepeatedCompare(str1,str5));
